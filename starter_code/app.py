...
from repository import db, Artist, Venue
from forms import *
...
def venues():
    ...
    return render_template('pages/venues.html', areas=getAllVenues()), status.HTTP_200_OK
...
def show_artist(artist_id):
    return render_template('pages/show_artist.html', artist=find_artist(artist_id))
